...
class Carrito:
    ...
    def agregar_producto(self, producto, cantidad=1):
        """
        Agrega un producto al carrito verificando que la cantidad \
        ...
        for item in self.items:
            if item.producto.nombre == producto.nombre:
                if item.cantidad > cantidad:
                    ...
                    raise ValueError("Cantidad a remover es mayor \
                        que la cantidad en el carrito")
                return
    ...
    def contar_items(self):
        """
        Retorna el número total de items (sumando las cantidades)
        en el carrito.
        """
    ...
    def aplicar_cupon(self, descuento_porcentaje, descuento_maximo):
        ...
        asegurando que el descuento no exceda el máximo permitido.
